...
use app\components\IPayable;
use app\traits\Payable;
use ra\admin\traits\SerializeAttribute;
use Yii;

class Order extends \ra\admin\models\Order implements IPayable
{
    use SerializeAttribute;


    use Payable;
    public $serializeAttributes = ['name', 'phone', 'email', 'city', 'address', 'comment'];
